    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-[540px] animate-modal-in flex flex-col max-h-[90vh]">
      ...
      <div class="px-7 py-6 overflow-y-auto space-y-5">
        ...
        <div class="flex items-center justify-between py-3 px-4 bg-slate-50 rounded-xl border border-slate-100">
          ...
          <button
            type="button"
            class="relative inline-flex w-11 h-6 rounded-full transition-colors duration-200 focus:outline-none bg-[#0258cb]"
          >
            <span class="inline-block w-5 h-5 bg-white rounded-full shadow transform transition-transform duration-200 mt-0.5 translate-x-5"></span>
          </button>
        </div>

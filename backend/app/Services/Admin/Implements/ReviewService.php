...
class ReviewService implements ReviewServiceInterface
{
    ...
    public function create(array $data): Model { throw new Exception("Not implemented"); }
    public function update(Model $model, array $data): Model { throw new Exception("Not implemented"); }
